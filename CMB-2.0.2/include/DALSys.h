...
void
_DALSYS_LogEventExt(DALDEVICEID DeviceId, uint32 dwLogEventType, const char * pszFmt,
...
*/
#define DALSYS_LogEvent(id,type,fmt,...) _DALSYS_LogEventExt(id,type,"[%s:%d] - " fmt,basename(__FILE__),__LINE__,##__VA_ARGS__)
