...
#if defined (__QNX__)
	SND_MIXER_SCHN_FRONT_LEFT_CENTER,
	SND_MIXER_SCHN_FRONT_RIGHT_CENTER,
	SND_MIXER_SCHN_REAR_LEFT_CENTER,
	SND_MIXER_SCHN_REAR_RIGHT_CENTER,
	SND_MIXER_SCHN_FRONT_LEFT_WIDE,
	SND_MIXER_SCHN_FRONT_RIGHT_WIDE,
	SND_MIXER_SCHN_FRONT_LEFT_HIGH,
	SND_MIXER_SCHN_FRONT_CENTER_HIGH,
	SND_MIXER_SCHN_FRONT_RIGHT_HIGH,
	SND_MIXER_SCHN_TOP_CENTER,
	SND_MIXER_SCHN_TOP_FRONT_LEFT,
	SND_MIXER_SCHN_TOP_FRONT_RIGHT,
	SND_MIXER_SCHN_TOP_FRONT_CENTER,
	SND_MIXER_SCHN_TOP_REAR_LEFT,
	SND_MIXER_SCHN_TOP_REAR_RIGHT,
	SND_MIXER_SCHN_TOP_REAR_CENTER,
	SND_MIXER_SCHN_TOP_FRONT_LEFT_CENTER,
	SND_MIXER_SCHN_TOP_FRONT_RIGHT_CENTER,
	SND_MIXER_SCHN_TOP_SIDE_LEFT,
	SND_MIXER_SCHN_TOP_SIDE_RIGHT,
	SND_MIXER_SCHN_TOP_LEFT_LFE,
	SND_MIXER_SCHN_TOP_RIGHT_LFE,
	SND_MIXER_SCHN_BOTTOM_CENTER,
	SND_MIXER_SCHN_BOTTOM_LEFT_CENTER,
	SND_MIXER_SCHN_BOTTOM_RIGHT_CENTER,
	SND_MIXER_SCHN_LAST = SND_MIXER_SCHN_BOTTOM_RIGHT_CENTER,
#else
...
#if defined (__QNX__)
const char *snd_mixer_selem_channel_name(snd_mixer_elem_t const * const elem, snd_mixer_selem_channel_id_t const channel);
#else
...
#if defined (__QNX__)
int snd_mixer_selem_has_playback_balance(snd_mixer_elem_t const * const elem);
int snd_mixer_selem_has_playback_fade(snd_mixer_elem_t const * const elem);
int snd_mixer_selem_has_capture_balance(snd_mixer_elem_t const * const elem);
int snd_mixer_selem_has_capture_fade(snd_mixer_elem_t const * const elem);
#endif
...
int snd_mixer_selem_set_capture_volume_range(snd_mixer_elem_t *elem, 
					     long min, long max);
#if defined (__QNX__)
int snd_mixer_selem_get_playback_balance(snd_mixer_elem_t const * const elem, long * const value, long * const min, long * const max);
int snd_mixer_selem_set_playback_balance(snd_mixer_elem_t * const elem, long const value);
int snd_mixer_selem_get_playback_fade(snd_mixer_elem_t const * const elem, long * const value, long * const min, long * const max);
int snd_mixer_selem_set_playback_fade(snd_mixer_elem_t * const elem, long const value);
int snd_mixer_selem_get_capture_balance(snd_mixer_elem_t const * const elem, long * const value, long * const min, long * const max);
int snd_mixer_selem_set_capture_balance(snd_mixer_elem_t * const elem, long const value);
int snd_mixer_selem_get_capture_fade(snd_mixer_elem_t const * const elem, long * const value, long * const min, long * const max);
int snd_mixer_selem_set_capture_fade(snd_mixer_elem_t * const elem, long const value);
...
#if defined (__QNX__)
unsigned int snd_mixer_selem_id_get_device(const snd_mixer_selem_id_t * const obj);
unsigned int snd_mixer_selem_id_get_subdevice(const snd_mixer_selem_id_t * const obj);
#endif
void snd_mixer_selem_id_set_name(snd_mixer_selem_id_t *obj, const char *val);
void snd_mixer_selem_id_set_index(snd_mixer_selem_id_t *obj, unsigned int val);
#if defined (__QNX__)
void snd_mixer_selem_id_set_device(snd_mixer_selem_id_t *obj, const unsigned int val);
void snd_mixer_selem_id_set_subdevice(snd_mixer_selem_id_t *obj, const unsigned int val);
#endif
