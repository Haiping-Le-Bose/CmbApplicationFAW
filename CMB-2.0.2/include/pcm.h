...
typedef enum _snd_pcm_format {
...
#if defined(__QNX__)
	/** Signed 18 bit in 3bytes format, CPU Endian */
	SND_PCM_FORMAT_S18_3 = SND_PCM_FORMAT_S18_3LE,
	/** Unsigned 18 bit in 3bytes format, CPU Endian */
	SND_PCM_FORMAT_U18_3 = SND_PCM_FORMAT_U18_3LE,
	/** Signed 20 bit in 3bytes format, CPU Endian */
	SND_PCM_FORMAT_S20_3 = SND_PCM_FORMAT_S20_3LE,
	/** Unsigned 20 bit in 3bytes format, CPU Endian */
	SND_PCM_FORMAT_U20_3 = SND_PCM_FORMAT_U20_3LE,
	/** Signed 24 bit in 3bytes format, CPU endian */
	SND_PCM_FORMAT_S24_3 = SND_PCM_FORMAT_S24_3LE,
	/** Unsigned 24 bit in 3bytes format, CPU endian */
	SND_PCM_FORMAT_U24_3 = SND_PCM_FORMAT_U24_3LE,
	/** Signed 16 bit non native endian */
	SND_PCM_FORMAT_S16_NN = SND_PCM_FORMAT_S16_BE,
	/** Unsigned 16 bit non native endian */
	SND_PCM_FORMAT_U16_NN = SND_PCM_FORMAT_U16_BE,
	/** Signed 20bit in 4bytes format, LSB justified, non native Endian */
	SND_PCM_FORMAT_S20_NN = SND_PCM_FORMAT_S20_BE,
	/** Unsigned 20bit in 4bytes format, LSB justified, non native Endian */
	SND_PCM_FORMAT_U20_NN = SND_PCM_FORMAT_U20_BE,
	/** Signed 24 bit non native endian */
	SND_PCM_FORMAT_S24_NN = SND_PCM_FORMAT_S24_BE,
	/** Unsigned 24 bit non native endian */
	SND_PCM_FORMAT_U24_NN = SND_PCM_FORMAT_U24_BE,
	/** Signed 32 bit non native endian */
	SND_PCM_FORMAT_S32_NN = SND_PCM_FORMAT_S32_BE,
	/** Unsigned 32 bit non native endian */
	SND_PCM_FORMAT_U32_NN = SND_PCM_FORMAT_U32_BE,
	/** Float 32 bit non native endian */
	SND_PCM_FORMAT_FLOAT_NN = SND_PCM_FORMAT_FLOAT_BE,
	/** Float 64 bit non native endian */
	SND_PCM_FORMAT_FLOAT64_NN = SND_PCM_FORMAT_FLOAT64_BE,
	/** IEC-958 non native Endian */
	SND_PCM_FORMAT_IEC958_SUBFRAME_NN = SND_PCM_FORMAT_IEC958_SUBFRAME_BE,
	/** Signed 18 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_S18_3NN = SND_PCM_FORMAT_S18_3BE,
	/** Unsigned 18 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_U18_3NN = SND_PCM_FORMAT_U18_3BE,
	/** Signed 20 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_S20_3NN = SND_PCM_FORMAT_S20_3BE,
	/** Unsigned 20 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_U20_3NN = SND_PCM_FORMAT_U20_3BE,
	/** Signed 24 bit in 3 bytes, non native endian */
	SND_PCM_FORMAT_S24_3NN = SND_PCM_FORMAT_S24_3BE,
	/** Unsigned 24 bit in 3 bytes, non native endian */
	SND_PCM_FORMAT_U24_3NN = SND_PCM_FORMAT_U24_3BE,
#endif
	...
	/** Signed 16 bit non native endian */
	SND_PCM_FORMAT_S16_NN = SND_PCM_FORMAT_S16_LE,
	/** Unsigned 16 bit non native endian */
	SND_PCM_FORMAT_U16_NN = SND_PCM_FORMAT_U16_LE,
	/** Signed 20bit in 4bytes format, LSB justified, non native endian */
	SND_PCM_FORMAT_S20_NN = SND_PCM_FORMAT_S20_LE,
	/** Unsigned 20bit in 4bytes format, LSB justified, non native endian */
	SND_PCM_FORMAT_U20_NN = SND_PCM_FORMAT_U20_LE,
	/** Signed 24 bit non native endian */
	SND_PCM_FORMAT_S24_NN = SND_PCM_FORMAT_S24_LE,
	/** Unsigned 24 bit non native endian */
	SND_PCM_FORMAT_U24_NN = SND_PCM_FORMAT_U24_LE,
	/** Signed 32 bit non native endian */
	SND_PCM_FORMAT_S32_NN = SND_PCM_FORMAT_S32_LE,
	/** Unsigned 32 bit non native endian */
	SND_PCM_FORMAT_U32_NN = SND_PCM_FORMAT_U32_LE,
	/** Float 32 bit non native endian */
	SND_PCM_FORMAT_FLOAT_NN = SND_PCM_FORMAT_FLOAT_LE,
	/** Float 64 bit non native endian */
	SND_PCM_FORMAT_FLOAT64_NN = SND_PCM_FORMAT_FLOAT64_LE,
	/** IEC-958 non native Endian */
	SND_PCM_FORMAT_IEC958_SUBFRAME_NN = SND_PCM_FORMAT_IEC958_SUBFRAME_LE,
	/** Signed 18 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_S18_3NN = SND_PCM_FORMAT_S18_3LE,
	/** Unsigned 18 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_U18_3NN = SND_PCM_FORMAT_U18_3LE,
	/** Signed 20 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_S20_3NN = SND_PCM_FORMAT_S20_3LE,
	/** Unsigned 20 bit in 3bytes format, non native endian */
	SND_PCM_FORMAT_U20_3NN = SND_PCM_FORMAT_U20_3LE,
	/** Signed 24 bit in 3 bytes, non native endian */
	SND_PCM_FORMAT_S24_3NN = SND_PCM_FORMAT_S24_3LE,
	/** Unsigned 24 bit in 3 bytes, non native endian */
	SND_PCM_FORMAT_U24_3NN = SND_PCM_FORMAT_U24_3LE,
#endif
#else
...
typedef enum _snd_pcm_state {
	...
	/** Hardware Error */
	SND_PCM_STATE_ERROR,
	/** PCM Device capability change */
	SND_PCM_STATE_CHANGE,
	SND_PCM_STATE_LAST = SND_PCM_STATE_CHANGE,
#else
	SND_PCM_STATE_LAST = SND_PCM_DISCONNECTED,
#endif
...
#if defined(__QNX__)
int snd_pcm_read_event(snd_pcm_t const * const pcm, snd_pcm_event_t * const event);
int snd_pcm_cm_activate (snd_pcm_t const * const pcm, bool const activate);
int snd_pcm_set_event_filter(snd_pcm_t const * const pcm, snd_event_filter_t const * const filter);
int snd_pcm_set_ap_data(snd_pcm_t const * const pcm, char const * const module_id, snd_pcm_ap_param_t * const param, void const * const data);
int snd_pcm_get_ap_data(snd_pcm_t const * const pcm, char const * const module_id, snd_pcm_ap_param_t * const param, void * const data);
#endif
...
#if defined (__QNX__)
int snd_pcm_link_mode(const snd_pcm_t * const pcm, const int mode);
int snd_pcm_link_transition(const snd_pcm_t * const pcm);
#endif
...
#if defined (__QNX__)
int snd_pcm_hw_params_is_pcm_mixer(const snd_pcm_hw_params_t * const params);
int snd_pcm_hw_params_is_pcm_splitter(const snd_pcm_hw_params_t * const params);
int snd_pcm_hw_params_is_pcm_router(const snd_pcm_hw_params_t * const params);
int snd_pcm_hw_params_has_position(const snd_pcm_hw_params_t * const params);
#endif
...
#if defined(__QNX__)
int snd_pcm_sw_params_set_sound_type(snd_pcm_sw_params_t * const params, char const * const sound_type);
char const * snd_pcm_sw_params_get_sound_type(snd_pcm_sw_params_t const * const params);
#endif
...
#if defined(__QNX__)
uint32_t snd_pcm_status_get_cm_state(const snd_pcm_status_t * const obj);
snd_pcm_uframes_t snd_pcm_status_get_frame_count(snd_pcm_t * const pcm, snd_pcm_status_t const * const obj);
#endif
