...
typedef BAF_Semaphore* (*BAF_Callback_Func_Semaphore_Create)(uint32_t count);

typedef  uint32_t (*BAF_Callback_Func_Semaphore_Post)(BAF_Semaphore* sem);

typedef  uint32_t (*BAF_Callback_Func_Semaphore_Pend)(BAF_Semaphore* sem);
