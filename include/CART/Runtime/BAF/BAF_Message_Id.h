...
typedef enum
{
	 ...
	 */
	BAF_MESSAGE_PASSTHRU_SINGLE = CART_MESSAGE_ID_DEFAULT,
	 ...
	 */
	BAF_MESSAGE_PASSTHRU_BROADCAST = CART_MESSAGE_ID_ALL,

	/**
	 * @ingroup BAF_Message_Id
	 *
	 * @brief 0x04 - Version querry
	 */
	BAF_MESSAGE_VERSION = CART_MESSAGE_ID_VERSION,
	 ...
	 */
	BAF_MESSAGE_NOTIFICATION_POLL = CART_MESSAGE_ID_NOTIFICATION_POLL,
	 ...
	 */
	BAF_MESSAGE_DEBUG = CART_MESSAGE_ID_DEBUG,
