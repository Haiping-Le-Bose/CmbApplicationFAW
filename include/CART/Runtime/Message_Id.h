...
typedef enum
{
	 ...
	 */
	MESSAGE_PASSTHRU_SINGLE = CART_MESSAGE_ID_DEFAULT,
	 ...
	 */
	MESSAGE_PASSTHRU_BROADCAST = CART_MESSAGE_ID_ALL,
	 ...
	 */
	MESSAGE_VERSION = CART_MESSAGE_ID_VERSION,
	 ...
	 */
	MESSAGE_NOTIFICATION_POLL = CART_MESSAGE_ID_NOTIFICATION_POLL,
	 ...
	 */
	MESSAGE_DEBUG = CART_MESSAGE_ID_DEBUG,
